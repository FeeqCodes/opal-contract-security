...
contract Omnipool is IOmnipool {
    ...
    // i: where all the pools are stored
    ...
    // --------------------------- CONSTRUCTOR ---------------------------
    // @audit we should be able to call this smart contract with a malicious contrcat containing our 
    // registryAcess and registryContract
    constructor(
    ...
    //  q: how many pools are created upon deployment?
    ...
    function getTotalTvl() public view returns (uint256) {
        uint256 totalTvl;
        // q: does this mean the total number of pools cant be greater than 2 * 8 - 1 = 255 po0ls ?
